...
In recent years, several literature reviews have been conducted to investigate the intersection of \acrshort{se} and \acrshort{ml}, mainly mapping practices and challenges to \acrfullpl{ka} of the SWEBOK \cite{Bourque2014} such as in \cite{Kumeno2020} and \cite{Nascimento2020}.
...
This study will attempt to answer the following \acrfullpl{rq}.
\begin{itemize}
...
\end{itemize}
In order to answer the \acrshortpl{rq}, a \acrfull{slr} was conducted based on the guidelines of \cite{Kitchenham07guidelinesfor} and \cite{Wohlin2014}.
