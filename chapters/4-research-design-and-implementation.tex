...
I will perform selection, while my supervisor Jinyue Li will review my selection.

\subsection{Study Quality Assessment}
Quality of both WL and GL were assessed using quality assessment forms based on \cite{Garousi2019}.
Quality assessment form adapted from \cite{Garousi2019}:
\begin{itemize}
    \item Methodology
    \begin{itemize}
        \item Does the source have a clearly stated aim?
        \item Does the source have a stated methodology?
        \item Are any limitations clearly stated?
        \item Does the work cover a speciﬁc question?
        \item Does the work refer to a particular population or case?
    \end{itemize}
    \item Objectivity
    \begin{itemize}
        \item Is there vested interest? E.g., a tool comparison by authors that are working for a particular tool vendor
    \end{itemize}
    \item Position w.r.t. related sources
    \begin{itemize}
        \item Have key related GL or formal sources been linked to/discussed?
    \end{itemize}
    \item Novelty
    \begin{itemize}
        \item Does it enrich or add something unique to the research?
        \item Does it strengthen or refute a current position?
    \end{itemize}
    \item Impact
    \begin{itemize}
        \item Normalize all the following impact metrics into a single aggregated impact metric (when data are available): Number of citations, Number of page or paper views
    \end{itemize}
\end{itemize}
