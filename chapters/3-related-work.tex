...
\textcite{John2021} performed a \acrfull{mlr} of the SE lifecycle of \acrshort{ml} models, outlining challenges and best practices in each step of the lifecycle.
